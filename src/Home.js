          ...
          <div className="row">
            <div className="col-md-4">
              <blockquote className="blockquote">
                <p>"Seagold Dormitory provides everything I need for comfortable student living!"</p>
                <footer className="blockquote-footer">John D., Engineering Student</footer>
              </blockquote>
            </div>
            <div className="col-md-4">
              <blockquote className="blockquote">
                <p>"The smart room controls and high-speed internet are game-changers for my studies."</p>
                <footer className="blockquote-footer">Jane M., IT Major</footer>
              </blockquote>
            </div>
            <div className="col-md-4">
              <blockquote className="blockquote">
                <p>"Being so close to my university has made my life easier. Highly recommend it!"</p>
      ...
      <section className="gallery-section container py-5">
        ...
        <div className="row">
          <div className="col-md-4 mb-3">
            <img src="/gallery1.jpg" alt="Dorm interior" className="img-fluid rounded" />
          </div>
          <div className="col-md-4 mb-3">
            <img src="/gallery2.jpg" alt="Common lounge" className="img-fluid rounded" />
          </div>
          <div className="col-md-4 mb-3">
            <img src="/gallery3.jpg" alt="Study areas" className="img-fluid rounded" />
          </div>
        </div>
      </section>
