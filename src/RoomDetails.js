  ...
  return (
    <div className="room-details-container">
      ...
      <div className="room-header">
        ...
        <div className="image-gallery">
          ...
          <div className="side-images">
            <img src="unit1.jpg" alt="Side 1" />
            <img src="unit2.jpg" alt="Side 2" />
            <img src="unit3.jpg" alt="Side 3" />
            <img src="unit4.jpg" alt="Side 4" />
          </div>
        </div>
      ...
      <div className="room-notes">
        <h4>Notes:</h4>
        <p>
          <strong>Rules on Excess Days:</strong> In half-month rents, charges will apply on a daily
          rate basis.
        </p>
        <p>
          <strong>Capacity of 1-2 Persons Room:</strong> Additional ₱3,500 applies.
        </p>
